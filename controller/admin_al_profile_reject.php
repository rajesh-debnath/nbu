...
if ($_SERVER["REQUEST_METHOD"] == "POST"){
 ...
 $sql = "INSERT INTO reject (r_reg_no,r_pwd,r_reason) VALUES ('".$_SESSION['pending_al_reg_no']."','".$_SESSION['pending_al_pwd']."','".$resone."' )";
  if ($conn->query($sql) === TRUE){ 
   ...
   unlink("../s_profile_pic/".$_SESSION['pending_al_pic']);

   $sql1 = "DELETE FROM alum_applicant WHERE al_reg_no='".$_SESSION['pending_al_reg_no']."'";

   if (mysqli_query($conn, $sql1)) {
      header("Location:".$baseurl."admin_alum_applicant_pending.php?reject=successfull");  
   }
   else {
     header("Location:".$baseurl."admin_alum_applicant_pending.php?reject=unsuccessfull");
  }
