...
<!-- Navbar End -->
 <center><p class="text-info m-2" name="error"> <?php echo $result; ?></p></center>
<!--Modal start -->
<div class="modal-dialog modal-dialog-centered text-center modal-lg">
		...
		<h3 style="font-family: Constantia";>Alumni Login</h3>

	<form action="controller/alum_login_inc.php" method="post" class="col-12">
	...
	<input type="submit" name="login" value="Login" id="stud_btn"class="btn-outline-info rounded w-50">
