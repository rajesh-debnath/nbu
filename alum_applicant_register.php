...
include 'controller/baseurlconfig.php';
 ...
 if (isset($_GET["error"])) {
    ...
    elseif ($_GET["error"] == "none") {
       header("location:".$baseurl."alum_login.php?result=applicationtaken");
    }
...
<!DOCTYPE html>
 ...
 <head>
    ...
    <!--    <link href="https://fonts.googleapis.com/icon?family=Material+Icons"
      ...
      <script type="text/javascript" src="<?php echo $baseurl; ?>js/al_registration.js"></script>
  </head>
  <style type="text/css">
...
<div class="container" style="padding-top: 95px;">
    <div class="row">
        <div class="col-md-8">
            <div class="header">
                ...
                <hr class="mt-3 pt-0" >
                <form action="controller/alum_applicant_register_inc.php" method="post" enctype="multipart/form-data">
                    <div class="field-set">
            ...
            <div class="field-set">
                <table class="table table-borderless font-weight-bold">
                    ...
                    <tr>
                        ...
                        <td><input type="text" id="sa_session" name="session" placeholder="Enter your session(e.g.:2001-2002)" onkeyup="s_a_session()">
                    ...
                    <tr>
                        ...
                        <td><input type="text" id="sa_email" name="mail" id="email" placeholder="Enter your Email Id(e.g.: example@abc.com)" onkeyup="s_a_email()"/>
                            <p id="e_email" class="text-danger small"></p>
                        </td>
                    </tr>
                    <tr>
                        <td><label for="m-number">Mobile Number:</label></td>
                        <td><input type="text" id="sa_mobile" name="phn_no" placeholder="Enter your 10 digit mobile number" onkeyup="s_a_mobile()">
            ...
            <div class="field-set">
                ...
                <div class="submit text-center pb-3">
                 <button type="button" id="submit" class="btn btn-outline-success mx-3"  name="register" onclick="validateFormalum()">Register</button>
             </div>
 ...
 <div class="col-md-4 pb-3 text-muted" style="padding-top: 78px;">
    ...
    <hr>
    <br />
    <a href="<?php echo $baseurl; ?>alum_login.php" class="btn btn-outline-success mx-3 ">Login Here</a>
</div>
</div>
</div>
